...
public class MemberVO {
	...
	@NotBlank(message = "개인정보동의는 필수입니다.", groups = Step1.class)
	...
	@NotBlank(message = "memName은 필수입니다.", groups = {Default.class, Step2.class})
	private String memName;                 /*회원이름*/
	@NotBlank(message = "memBir는 필수입니다.", groups = {Default.class, Step3.class})
	// @Pattern(regexp = "", message = "날짜형식이 아닙니다.")
	private String memBir;                  /*회원생일*/
	@NotBlank(message = "memZip는 필수입니다.", groups = {Default.class, Step3.class})
	private String memZip;                  /*회원우편번호*/
	@NotBlank(message = "memAdd1은 필수입니다.", groups = {Default.class, Step3.class})
	private String memAdd1;                 /*회원주소*/
	@NotBlank(message = "memAdd2은 필수입니다.", groups = {Default.class, Step3.class})
	private String memAdd2;                 /*회원상세주소*/
	@NotBlank(message = "memHp은 필수입니다.", groups = {Default.class, Step3.class})
	private String memHp;                   /*회원전화번호*/
	@NotBlank(message = "memMail는 필수입니다.", groups = {Default.class, Step2.class})
	private String memMail;                 /*회원이메일*/
	@NotBlank(message = "memJob은 필수입니다.", groups = {Default.class, Step3.class})
	private String memJob;                  /*회원직업*/
	@NotBlank(message = "memLike는 필수입니다.", groups = {Default.class, Step3.class})
