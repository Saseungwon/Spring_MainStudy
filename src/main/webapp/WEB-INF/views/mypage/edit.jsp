 ...
 <div class="container">	
	...
	<table class="table table-striped table-bordered">
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<select name="memLike" class="form-control input-sm" >
						...
						<option value="${hobby.commCd }" ${member.memLike eq hobby.commCd ? "selected='selected'" : ""}>${hobby.commNm }</option>						
						</c:forEach>
			...
			<tr>
				<td colspan="2">
					<a href="${pageContext.request.contextPath}/" class="btn btn-info btn-sm">
