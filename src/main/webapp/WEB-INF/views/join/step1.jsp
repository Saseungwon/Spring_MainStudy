...
<body>
	...
	<div class="container">
		<form:form modelAttribute="member" action="step2.wow">
			<div class="row col-md-8 col-md-offset-2">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<label><form:checkbox path="privacyYn" value="Y"/> 개인정보 수집 및 이용에 대한 동의 <span class="required">(필수)</span> 
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<label> <form:checkbox path="eventYn" value="Y"/>이벤트 등 프로모션 알림 메일 수신 <span class="optional">(선택)</span>
